...
"""
Django settings for icaroslabs_org project.
...
SECRET_KEY = 'fe2d!*=yethkug0-sbl=k6dh$_7qyk6j41^$uf705cy(!%@7x3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [u'localhost', u'.icaroslabs.org', u'www.icaroslabs.org']
...
ROOT_URLCONF = 'icaroslabs_org.urls'



WSGI_APPLICATION = 'icaroslabs_org.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'icaroslabs_org', 'templates'),],
        'OPTIONS': {
            'context_processors': [
